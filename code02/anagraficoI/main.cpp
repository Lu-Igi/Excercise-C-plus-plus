                                            ...
                                            cout<<"\n";
                                                ...
                                                cout<<"\n";
                                                    ...
                                                    cout<<"\n";
                                                        ...
                                                        cout<<"Digita 'N' per iniziare una nuova sessione oppure un qualsiasi altro tasto per concludere.";
                                                        cin>>nuovaSessione;
                                                        /*significa che noi abbiamo la variabile uguale alla'assegnazione è risponderà esito positivo */
                                                        }while(nuovaSessione=='N');

                                                        /*cout<<"Digita per terminare 'Y'";
                                                        cin>>terminaSessione;
                                                        }while(terminaSessione!='Y');
*/
